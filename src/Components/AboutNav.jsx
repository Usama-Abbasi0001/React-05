    ...
    <>
      ...
      >
        ...
        <div className=" space-x-4 lg:flex hidden">
          <div className="flex">
            <input
              className="bg-gray-100 p-2 rounded-[4px] relative w-[15rem]"
              type="search"
              name="name"
            ...
            <img
              ...
              className="bg-gray-100 p-2 rounded-[4px] relative '"
              alt=""
            />
          </div>
          <div>
          ...
          <div>
            <img src={require("./images/with.png")} alt="" />
          </div>
          <div>
            <img src={require("./images/userman.png")} alt="" />
          </div>
        </div>
